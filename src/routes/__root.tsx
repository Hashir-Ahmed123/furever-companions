  ...
  head: () => ({
    meta: [
      ...
      { title: "FurEver Care — They Deserve Forever Love" },
      {
        name: "description",
        content:
          "FurEver Care is a warm pet care platform for owners, veterinarians and shelter volunteers.",
      },
      { name: "author", content: "FurEver Care" },
      { property: "og:title", content: "FurEver Care — They Deserve Forever Love" },
      {
        property: "og:description",
        content: "Pet profiles, feeding guides, adoption galleries and vet tools in one place.",
      },
